<nav class="navbar navbar-vertical navbar-expand-lg" style="display:none;">
    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        ...
        <ul class="navbar-nav flex-column" id="navbarVerticalNav">
            ...
            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#CRM" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="CRM">
                ...
                <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="CRM">
                    ...
                    <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Analytics</span><span class="badge ms-2 badge badge-phoenix badge-phoenix-info ">New</span></div>
                    </a><!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="apps/crm/deal-details.html" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Deal details</span><span class="badge ms-2 badge badge-phoenix badge-phoenix-info ">New</span></div>
                    </a><!-- more inner pages-->
                    </li>
            ...
            <div class="nav-item-wrapper"><a class="nav-link label-1 {{ request()->is('usuarios') ? 'active' : '' }}" href="usuarios" role="button" data-bs-toggle="" aria-expanded="false">
                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fa-brands fa-gulp fs-0 ms-1 me-1"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Usuarios</span></span></div>
                </a></div><!-- parent pages-->
